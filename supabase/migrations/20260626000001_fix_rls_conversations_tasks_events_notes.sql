-- Repair RLS mismatches: DM conversation creation, executive task/event writes, events.notes column.
...
-- ─── conversations ───
-- INSERT ... RETURNING requires SELECT visibility for the creator before members exist.
...
-- Internal executive notes/recap on events (distinct from public description).
