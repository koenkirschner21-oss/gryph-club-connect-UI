-- Allow report notification inbox types for moderation queues and reporter updates.
...
ALTER TABLE public.inbox_messages
  ...
  CHECK (type IN (
    ...
    'role_updated', 'system_message', 'event_cancelled', 'meeting_cancelled',
    'member_removed', 'report_submitted', 'report_status_updated'
  ));
