    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-section sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h2 className="text-4xl font-extrabold text-white">Featured Clubs</h2>
      ...
      {savedClubList.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 py-section sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="text-4xl font-extrabold text-white">Your Saved Clubs</h2>
            <p className="mt-4 text-lg text-muted">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 btn-gradient-red" aria-hidden="true" />
